...
ActiveRecord::Schema.define(version: 2020_08_25_102203) do
  ...
  create_table "addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_item_id"], name: "index_addresses_on_purchase_item_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "flat_family_name", null: false
    t.string "flat_first_name", null: false
  ...
  add_foreign_key "addresses", "purchase_items"
